    ...
    >
      ...
      <ChannelSeoCard title="纽约华人新闻资讯与新手生活指南">
        <div className="space-y-3">
          <p>
            OpenAA 新闻资讯频道面向纽约华人、美国华人、新移民和留学生整理本地新闻、社区动态、DMV 教程、生活指南和平台公告。很多用户第一次来到纽约时，会同时需要找房、找工作、查交通、看政策变化和了解社区信息，因此新闻频道会把这些内容集中到一个移动端友好的页面里。
          </p>
          <p>
          ...
          <p>
            OpenAA 新闻频道不追求堆砌标题，而是希望把纽约华人生活中经常会用到的信息解释清楚：哪些内容适合新移民，哪些属于社区动态，哪些只是平台公告。随着 OpenAA 内容增加，新闻资讯会和招聘、房屋租售、二手市场、本地服务、DMV 工具中心形成互相补充的生活信息入口，让用户在一个站内完成浏览、搜索和继续阅读。
          </p>
