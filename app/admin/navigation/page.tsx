        ...
        return (
          <div className="space-y-4">
            ...
            <section className="bg-white">
              ...
              <Link href="/admin/navigation/recycle-bin" className="mt-3 inline-flex min-h-10 items-center justify-center rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-black text-slate-700 hover:bg-slate-50">
                导航删除管理
              </Link>
            </section>
