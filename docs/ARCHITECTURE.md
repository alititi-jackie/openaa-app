...
The global header includes a city entry for New York and an expandable horizontal quick navigation bar. The current frontend uses `fallbackTopQuickLinks` so the shell works without Supabase environment variables.
