...
export function NavigationMyCard() {
  return (
    <Link
      href="/navigation/my"
      className="group block rounded-3xl border border-blue-100 bg-blue-50 p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md"
    >
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-sm leading-5 text-slate-500">保存自己的常用网站，下次打开更方便</p>
        </div>
