...
export function HousingContactRevealCard({ postId }: { postId: string }) {
    ...
    <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      ...
      {contact ? (
        ...
        <button
          ...
          disabled={loading}
          className="mt-3 inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-lg bg-slate-950 px-4 py-3 text-sm font-bold text-white disabled:cursor-not-allowed disabled:bg-slate-300"
        >
