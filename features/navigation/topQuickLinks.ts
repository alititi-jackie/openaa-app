...
export const fallbackTopQuickLinks: TopQuickLink[] = [
  ...
  { id: "marketplace", title: "二手", url: "/marketplace", open_mode: "same", sort_order: 30, is_active: true, city_id: "ny", icon: "shopping-bag" },
  ...
  { id: "feedback", title: "线索与建议", url: "/feedback", open_mode: "same", sort_order: 80, is_active: true, city_id: "ny", icon: "message-square" },
];
