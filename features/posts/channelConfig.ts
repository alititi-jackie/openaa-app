...
export const POST_CHANNEL_CONFIGS: Record<PostType, PostChannelConfig> = {
  job: {
    ...
    manageRoute: "/profile/posts?type=jobs",
    displayLabel: "招聘",
  ...
  housing: {
    ...
    manageRoute: "/profile/posts?type=housing",
    displayLabel: "房屋",
    icon: Building2,
  ...
  marketplace: {
    ...
    publishRoute: "/marketplace/publish",
    manageRoute: "/profile/posts?type=marketplace",
    displayLabel: "二手",
    icon: ShoppingBag,
    modeOptions: MARKETPLACE_MODE_OPTIONS,
    categoryOptions: MARKETPLACE_CATEGORY_OPTIONS,
    areaOptions: LOCATION_OPTIONS,
    imageConfig: POST_IMAGE_CONFIG,
  ...
  service: {
    ...
    manageRoute: "/profile/posts?type=services",
    displayLabel: "本地服务",
    icon: Store,
